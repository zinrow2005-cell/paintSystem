const CACHE_NAME = 'kids-drawing-v1-7-52-practice-pronounce-20260913-01';
...
self.addEventListener('fetch', event => {
  ...
  const isCoreCode = ['index.html','styles-v1752.css','app-v1752.js','lineart.js','manifest.webmanifest'].some(name => url.pathname.endsWith('/'+name));
